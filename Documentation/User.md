...
![Clone Repository](https://github.com/welawrence543/AWS-Visual-Configuration-App/blob/master/Auxiliary%20Files/clonerepo.JPG?raw=true)
**Step 1**: Clone the repository.
- First, select a desired branch to clone.  Second, copy the clone link for HTTPS.

![Open in Visual Studio: Part A](https://github.com/welawrence543/AWS-Visual-Configuration-App/blob/master/Auxiliary%20Files/vsinit.JPG?raw=true)
**Step 2**: Open on Visual Studio
- Open the project on Visual Studio by clicking "Clone a Repository" under "Getting Started."

![Open in Visual Studio: Part B](https://github.com/welawrence543/AWS-Visual-Configuration-App/blob/master/Auxiliary%20Files/vs2.JPG?raw=true)
**Step 3**: Create clone project.
- Paste the copied clone link into the "Repository Location" field, choose a good spot to save it locally, then press "Clone."
...
**Step 4**: Get into test explorer / Run Tests
...
**Step 5**: Test Explorer
- Test explorer is a fairly complex, but by taking the previous step you should have ran ALL tests for the software in the active branch.  You can fine-tune testing with Test Explorer.  Further details on how to use Test Explorer can be found [here](https://docs.microsoft.com/en-us/visualstudio/test/run-unit-tests-with-test-explorer?view=vs-2019)
